...
if (isset($_POST['envoye']))
{
    ...
    * vers la page d'accueil */
    if($_SERVER['HTTP_REFERER'] != 'http://wp.challinge.net/tinymce/contact.php')
    {
        header('Location: http://wp.challinge.net/tinymce/contact.php');
    }
...
<form action="http://wp.challinge.net/tinymce/contact.php" method="post" enctype="multipart/form-data">
    <p>
